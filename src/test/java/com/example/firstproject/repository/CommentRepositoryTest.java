...
class CommentRepositoryTest {
    ...
    void findByArticleId() {
        /* Case 1: 4번 게시글의 모든 댓글 조회 */
        {
            ...
            Comment b = new Comment(2L, article, "Song", "비긴어게인");
            Comment c = new Comment(3L, article, "Choi", "라라랜드");
    ...
    void findByNickname() {
        /* Case 1: "Park"의 모든 댓글 조회 */
        {
            ...
            // 3. 예상 데이터
            Comment a = new Comment(1L, new Article(4L, "당신의 인생 영화는?", "댓글 고"), "Park", "굿 월 헌팅");
